...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <form class="gform" id="firstFormID" method="POST"  action="https://script.google.com/macros/s/AKfycbwb4r3XlPk7tapqwxbY6Ohne3kmrAlcqFRBQT2ySopx5NsU_EH-KbzyIgpaBJ4VB8Uz/exec"> 
 ...
 <h2><em>Thanks</em> for contacting us! We will get back to you soon!
          ...
          <input onclick="showModal()" type="submit"  class="btn btn-success btn-block">
        </form>
