                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="user-manage-booking.php?del=<?php echo $row->u_id;?>" class="badge badge-danger" onclick="return confirm('Are you sure you want to delete this appointment?');"><i class="fa fa-trash"></i> Delete</a>
                    </td>
